...
<?php $this->start('side_content') ?>
    ...
    <p>
        Si vous remarquez un commentaire inapproprié, merci de décrire les raisons de ce signalement, un message sera envoyé aux modérateurs de run|rum.
    </p>
...
<article>
    ...
    <form name="fSignalerReponse"  enctype="multipart/form-data" method="POST" >
...
<!-- ============================================================= --> 
            ...
            <p>
                <input type="hidden" name="form[reponse_id]" class="fondForum" value=<?php 
...
<!-- ============================================================= -->
            <div class="enLigne">
                ...
                <ul id="navComment">
                    ...
                    <li>
                        <a href="<?= $this->url('forumListeReponses', ['id' => $post]) ?>" class="sansSoulign">Annuler</a>
                    </li>
                    <li>
